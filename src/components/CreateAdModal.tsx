...
export function CreateAdModal() {
  ...
  async function handleCreateAd(event: FormEvent) {
   ...
   try {
    ...
    alert('ops, não foi possível cadastrar')
   }
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed rounded-lg w-[90%] sm:w-[480px] bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 shadow-lg shadow-black/25">
